# 🚀 ESP32 Smart Garage Door Opener & Magnetic Position Monitor
...
Smart Garage Door Controller with Magnetic Reed Switch Open/Close Sensors and Apple HomeKit/MQTT support.
...
+--------------------+-----------------------+---------------------+
| GPIO 26 | Relay Dry Contact | Wall Button Trigger |
| GPIO 14 | Reed Switch Top (Open) | Position Sensor |
| GPIO 27 | Reed Switch Bottom (Closed) | Position Sensor |
+--------------------+-----------------------+---------------------+
```
...
├── esp32-garage-door-opener.ino           # Main Arduino C++ sketch
