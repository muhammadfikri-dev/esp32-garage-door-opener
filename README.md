# ⚡ Pengontrol Pintu Garasi Pintar & Sensor Posisi Magnetik
...
Sistem kontrol buka-tutup motor pintu garasi dengan sensor switch magnetik reed status buka/tutup, lampu sentry keselamatan, dan integrasi geofencing.
...
1. Buka file **`esp32-garage-door-opener.ino`** menggunakan **Arduino IDE 2.0+** atau PlatformIO.
